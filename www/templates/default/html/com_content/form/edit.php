...
<div class="edit item-page<?php echo $this->pageclass_sfx; ?> row-fluid">
	<form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
		<fieldset>
			<legend><?php echo JText::_('Add an Update'); ?></legend>
			<div class="formelm control-group"> <?php echo $this->form->getLabel('title'); ?>
				<div class="controls"> <?php echo $this->form->getInput('title'); ?> <?php echo $this->form->getInput('ids'); ?> </div>
			</div>
		...
		<fieldset>
			...
			<div class="formelm control-group"> <?php echo $this->form->getLabel('sendemail'); ?>
				<div class="controls"><?php echo $this->form->getInput('sendemail'); ?> </div>
			</div>
			...
			<div class="control-group">
				<div class="form-note controls">
					<?php /*?><p class="help-block"><?php echo JText::_('COM_CONTENT_ORDERING'); ?></p><?php */?>
				</div>
			</div>
			<?php endif; ?>
		</fieldset>
