...
<div class="item-page<?php echo $this->pageclass_sfx?> row-fluid">
	...
	<?php if (JRequest::getVar('id')=='17' && JRequest::getVar('option')=='com_content'|| JRequest::getVar('id')=='43' && JRequest::getVar('option')=='com_content' || JRequest::getVar('id')=='44' && JRequest::getVar('option')=='com_content' ||  JRequest::getVar('id')=='45' && JRequest::getVar('option')=='com_content' ||  JRequest::getVar('id')=='46' && JRequest::getVar('option')=='com_content' ||  JRequest::getVar('id')=='47' && JRequest::getVar('option')=='com_content' ||  JRequest::getVar('id')=='48' && JRequest::getVar('option')=='com_content' ||  JRequest::getVar('id')=='49' && JRequest::getVar('option')=='com_content' ||  JRequest::getVar('id')=='50' && JRequest::getVar('option')=='com_content' ||  JRequest::getVar('id')=='51' && JRequest::getVar('option')=='com_content' ||  JRequest::getVar('id')=='52' && JRequest::getVar('option')=='com_content'  ||  JRequest::getVar('id')=='53' && JRequest::getVar('option')=='com_content'  ) {?>
		<p class="h1"> <?php echo $this->escape($this->params->get('page_heading')); ?> </p>
	<? } else { ?>	
