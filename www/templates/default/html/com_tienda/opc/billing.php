...
<form id="opc-billing-form" name="opc-billing-form" action="" method="post">
    ...
    <fieldset id="new-billing-address" class="<?php if (!empty($this->user->id) && !empty($this->addresses)) { echo "opc-hidden"; } ?>">
        ...
        <div class="control-group">
            ...
            echo TiendaSelect::country( 223, $this->form_prefix.'country_id', $attribs, $this->form_prefix.'country_id', true, true );
            ?>
        </div>
        <?php endif; ?>
		...
		<div class="control-group">
			...
			<div id="<?php echo $this->form_prefix; ?>zones_wrapper">
				...
				echo TiendaSelect::zone( '', $this->form_prefix.'zone_id', 223 , $attribs, $this->form_prefix.'zone_id' );
				?>
			</div>
		</div>
		<?php endif; ?>
    ...
    <a id="opc-billing-button" class="btn btn-primary"><?php echo JText::_('COM_TIENDA_CONTINUE') ?></a>
