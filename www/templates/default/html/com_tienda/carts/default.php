...
if( JRequest::getInt('funding', '0') == 1 ) {
...
<div class="cartitems">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_tienda&view=carts&task=update&Itemid='.$router->findItemid( array('view'=>'carts') ) ); ?>" method="post" name="adminForm" enctype="multipart/form-data">
        ...
        <a class="btn btn-funding"  href="<?php echo JRoute::_('index.php?option=com_tienda&view=checkout&Itemid='.$this->checkout_itemid ); ?>" onclick="return tiendaCheckUpdateCartQuantities(document.adminForm, '<?php echo JText::_('COM_TIENDA_CHECK_CART_UPDATE'); ?>');">
        ...
        <table class="adminlist">
            ...
            <?php foreach ($items as $item) : ?>
                ...
                <tr class="row<?php echo $k; ?>">
                    ...
                    <td class="prodimg">
                    	<img class="img-rounded img-polaroid" src="<?php echo TiendaHelperCampaign::getImage($item->campaign, 'thumb','',true); ?>" >
            ...
            <tfoot>
                <tr>
                    <td colspan="3" style="text-align: left;">
                        <input type="submit" class="button btn btn-danger" value="<?php echo JText::_('COM_TIENDA_REMOVE_SELECTED'); ?>" name="remove" />
                    </td>
                    <td colspan="2">
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <a class="btn blacktext" href="<?php echo $this->return; ?>">
                            Back to Campaigns
                        </a>
                        <?php } ?>
                    </td>
