...
<tr>
	<td style="width: 70%; max-width: 70%; vertical-align: top; padding-right: 5px;">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-small" href="<?php echo JRoute::_("index.php?option=com_tienda&view=accounts&task=edit"); ?>">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-small" href="<?php echo JRoute::_( $this->url_profile ); ?>">
                        <?php echo JText::_('COM_TIENDA_EDIT'); ?>
                    </a>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-small" href="<?php echo JRoute::_("index.php?option=com_tienda&view=addresses"); ?>">
                        <?php echo JText::_('COM_TIENDA_EDIT'); ?>
                    </a>
                </td>
            </tr>
