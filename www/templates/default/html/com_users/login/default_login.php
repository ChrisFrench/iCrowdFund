...
<div class="login<?php echo $this->pageclass_sfx?> span6">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-horizontal">
		<fieldset>
			...
			<?php if (!$field->hidden): ?>
			<div class="login-fields control-group"> <?php echo $field->label; ?>
	...
	<?php
		...
		<div class="signup span4 "><a class="btn btn-funding btn-large center" href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>"> <?php echo JText::_('COM_USERS_LOGIN_REGISTER'); ?></a></div>  </li>
		<?php endif; ?>
