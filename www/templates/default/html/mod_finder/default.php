...
$output = '<input type="text" name="q" id="mod-finder-searchword" class="inputbox input-medium search-query" size="' . $params->get('field_size', 20) . '" value="' . htmlspecialchars(JFactory::getApplication()->input->get('q', '', 'string')) . '" />';
$button = '';
$label = '';
...
<form id="mod-finder-searchform" action="<?php echo JRoute::_($route); ?>" method="get" class="form-horizontal form-search">
	<div class="finder">
		<?php
