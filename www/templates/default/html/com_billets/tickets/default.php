...
<div id="campaignHeader" class="full greyTopHeader"><h1 class="indent-60"> <span><?php echo JText::_('COM_BILLETS_MY_TICKETS'); ?></span></h1></div>
    ...
    <table>
        <tr>
            ...
            <td style="white-space: nowrap; text-align: right; vertical-align: bottom;">
                <?php $attribs = array('class' => 'inputbox',  'onchange' => "document.adminForm.limitstart.value='0'; document.adminForm.submit();" ); ?>
                ...
                <input type="text" id="search_filter" name="filter" value="<?php echo @$state->filter; ?>" />
                <button class="btn btn-primary" onclick="document.adminForm.submit();"><?php echo JText::_('COM_BILLETS_SEARCH'); ?></button>
                <button class="btn btn-danger" onclick="document.adminForm.search_filter.value=''; document.adminForm.submit();"><?php echo JText::_('COM_BILLETS_RESET'); ?></button>
            </td>
        </tr>
        <tr>
            ...
            <td style="white-space: nowrap; text-align: right; vertical-align: bottom; padding: 5px;">
                <span class="label pull-left"><?php echo JText::_('COM_BILLETS_DATE_FROM'); ?>:</span>
                <div class="input-append pull-left" style="padding: 5px;" >
                    <?php echo JHTML::calendar( @$state->filter_date_from, "filter_date_from", "filter_date_from", JText::_($datelayout) ); ?>
				</div>
                <span class="label pull-left"><?php echo JText::_('COM_BILLETS_DATE_TO'); ?>:</span>
                <div class="input-append pull-left" style="padding: 5px;" >
