...
<div id="campaignHeader" class="full"><h1 class="indent-60"> <span><?php echo JText::_('COM_BILLETS_VIEW_TICKET'); ?></span></h1></div>
<br><br>
...
<form action="<?php echo JRoute::_( @$form['action'] ) ?>" method="post" class="adminform" name="adminForm" enctype="multipart/form-data">
			...
			<tbody>
				...
				if (BilletsHelperTicket::canView( $row->id, JFactory::getUser()->id )) 
				{
	                ...
	                <div id="addcomment" style="display: none">
						...
						{
						?>
							<div class="alert alert-info"><button type="button" class="close" data-dismiss="alert">×</button><?php echo JText::_('COM_BILLETS_ATTACHMENT_INTRO'); ?></div>
							<p><input class="text_area" name="userfile[]" type="file" size="25" /> <a class="btn btn-success" href="javascript:void(0);" onclick="Billets.addAnotherFile('<?php echo JText::_('COM_BILLETS_REMOVE');?>')"><?php echo JText::_('COM_BILLETS_ADD_MORE_FILES');?></a></p>
						...
						?>
						<br/>
						<button class="btn btn-primary" onclick="document.adminForm.tasks.value='addcomment'; document.adminForm.submit();"><?php echo JText::_('COM_BILLETS_SUBMIT_COMMENT_AND_ATTACHMENT'); ?></button>
	                </div>
					</td>
					</tr>
					<?php
	...
	?>
		...
		<tbody>
			<tr>
				<td>
				<div class="alert alert-info"><button type="button" class="close" data-dismiss="alert">×</button><?php echo JText::_('COM_BILLETS_CLOSE_TICKET_INTRO'); ?></div>
				</td>
			</tr>
			<tr>
				<td>
					...
					<input type='button' class='btn btn-info' style="float: left; margin-right: 5px;" onclick="if (confirm('<?php echo JText::_('COM_BILLETS_CLOSE_AND_RATE_TICKET_WARNING');?>')) { document.adminForm.apply_rating.value='2'; document.adminForm.tasks.value='closeticket'; document.adminForm.submit(); }" value='<?php echo JText::_('COM_BILLETS_POOR'); ?>' />
					<input type='button' class='btn btn-alert' style="float: left; margin-right: 5px;" onclick="if (confirm('<?php echo JText::_('COM_BILLETS_CLOSE_AND_RATE_TICKET_WARNING');?>')) { document.adminForm.apply_rating.value='3'; document.adminForm.tasks.value='closeticket'; document.adminForm.submit(); }" value='<?php echo JText::_('COM_BILLETS_AVERAGE'); ?>' />
					<input type='button' class='btn btn-primary' style="float: left; margin-right: 5px;" onclick="if (confirm('<?php echo JText::_('COM_BILLETS_CLOSE_AND_RATE_TICKET_WARNING');?>')) { document.adminForm.apply_rating.value='4'; document.adminForm.tasks.value='closeticket'; document.adminForm.submit(); }" value='<?php echo JText::_('COM_BILLETS_GOOD'); ?>' />
					<input type='button' class='btn btn-success' style="float: left; margin-right: 5px;" onclick="if (confirm('<?php echo JText::_('COM_BILLETS_CLOSE_AND_RATE_TICKET_WARNING');?>')) { document.adminForm.apply_rating.value='5'; document.adminForm.tasks.value='closeticket'; document.adminForm.submit(); }" value='<?php echo JText::_('COM_BILLETS_GREAT'); ?>' />
				</td>
			</tr>
		</tbody>
		</table>
