...
<div id="campaignHeader" class="full"><h1 class="indent-60"> Create Ticket</h1></div>


<br><br>
<div class="alert alert-info"><button type="button" class="close" data-dismiss="alert">×</button><?php echo JText::_('COM_BILLETS_CATEGORIZE_TICKET'); ?></div>
		...
		<div id="validationmessage"></div>
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td colspan="2">
                        <div class="alert alert-info"><button type="button" class="close" data-dismiss="alert">×</button><?php echo JText::_('COM_BILLETS_PLEASE_SELECT_THE_ORDER_THIS_ISSUE_APPLIES_TO'); ?></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
<?php
	if (!empty($row->id))
	{
		echo " <a class='btn btn-info pull-left'  href='".JRoute::_("index.php?option=com_billets&view=tickets&task=view&id=".$row->id)."'><< ".JText::_('COM_BILLETS_CANCEL_AND_RETURN_TO_TICKET')."</a>";		
	} 
	else
	{
		echo " <a class='btn btn-info pull-left' href='".JRoute::_("index.php?option=com_billets&view=tickets")."'><< ".JText::_('COM_BILLETS_CANCEL_AND_RETURN_TO_TICKET_LIST')."</a>";	
	}
?>
	<input type="button" class="btn btn-primary pull-right" onclick="document.adminForm.task.value='save'; submitbutton('save');" value="<?php echo JText::_('COM_BILLETS_SUBMIT'); ?>" />
