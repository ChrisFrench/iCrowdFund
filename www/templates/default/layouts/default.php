            ...
            <div id="content-wrapper" class="clearfix wrap center outer">
            	...
            	<div id="content" class="clearfix wrap center ">
					...
					<?php if ($display_component) { ?>
		                ...
		                <div id="main-column" class="<?php if (!$leftComponent && !$rightComponent) { echo 'full '; } ?> left wrap <?php if ($leftComponent) { echo "with-left"; } ?> <?php if ($rightComponent) { echo "with-right"; } ?><?php if ($rightwComponent) { echo "with-right-why"; } ?>">
		                ...
		                <?php } ?>
		                <?php if ($rightwComponent) { ?>
						 <jdoc:include type="modules" name="right-navigation" style="default" />
		                <?php } ?>
	                <?php } ?>
