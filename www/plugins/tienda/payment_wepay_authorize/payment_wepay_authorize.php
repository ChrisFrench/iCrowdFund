...
class plgTiendaPayment_wepay_authorize extends TiendaPaymentPlugin {
    /**
     *
     *
     ...
     */
    var $_element = 'payment_wepay_authorize';
    ...
    function onGetPaymentOptions($element, $order) {
        ...
        if ($found) {
            ...
            foreach ($orderitems as $item) {
                ...
                if($item->campaign->fundingtype == 2 || $item->campaign->fundingtype == 3 || $item->campaign->fundingtype == 4 ) {
                   $found = false; 
                }
            }
        }
