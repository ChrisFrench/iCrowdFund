...
class plgTiendaCampaign_allornothing extends TiendaPluginBase
{
	/**
	 * @var $_element  string  Should always correspond with the plugin's filename, 
	 *                         forcing it to be unique 
	 */
	var $_element = 'campaign_allornothing';
	var $_campaigns = null;
	var $_campaign = null;
	...
	function getCampaignsThatEnded() {
        ...
        $query->where("tbl.fundingtype = '1'");
        $query->where("tbl.campaign_raised >= tbl.campaign_goal");
