...
class MessagebottleModelTools extends MessagebottleModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'messagebottle'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh)) 
		{
		    ...
		    {
		        $item->link = 'index.php?option=com_messagebottle&view=tools&task=view&id='.$item->id;
		    }		    
		} 
