...
class MessagebottleTableScopes extends DSCTable 
{
	function MessagebottleTableScopes( &$db ) 
	{
		$tbl_key 	= 'scope_id';
		$tbl_suffix = 'scopes';
	...
	function delete( $oid = null )
	{
	    ...
	    {
	        $query = "DELETE FROM #__messagebottle_relationships WHERE `scope_id` = '$scope_id';";
	        $db = $this->getDBO();
	        $db->setQuery($query);
	        $db->query();
	    }
