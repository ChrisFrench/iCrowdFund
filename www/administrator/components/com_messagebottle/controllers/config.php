...
class MessagebottleControllerConfig extends MessagebottleController 
{
    /**
     * constructor
     */
    ...
    function save() 
    {
        ...
        $redirect = "index.php?option=com_messagebottle";
        ...
        $cache = JFactory::getCache('com_messagebottle.defines');
        $cache->clean();
    }
