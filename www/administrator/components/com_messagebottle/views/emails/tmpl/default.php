	...
	<table class="table table-striped table-bordered" style="clear: both;">
		<thead>
            <tr>
                ...
                <th style="width: 50px;">
                	<?php echo DSCGrid::sort( 'ID', "tbl.email_id", @$state->direction, @$state->order ); ?>
                </th>
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					<?php echo DSCGrid::checkedout( $item, $i, 'email_id' ); ?>
				</td>
				<td style="text-align: center;">
                ...
                <td style="text-align: center;">
                  	<?php if(!$item->sent) : ?>
                    <img src="/media/dioscouri/images/publish_x.png" border="0" alt="Sent">
                    <?php else : ?>
                    <img src="/media/dioscouri/images/tick.png" border="0" alt="Not Sent">
                    <?php endif; ?>
                </td>
                <td style="text-align: center;">
                    <?php echo $item->sentdate; ?>
                </td>
                <td style="text-align: center;">
