...
class TiendaHelperEmail extends TiendaHelperBase
{
    ...
    private function getEmailContent( $data, $type = 'order' ) 
    {
        ...
        $type = strtolower($type);  
         ...
         // to silence errors for now, maybe for defaults later
        ...
        $view->set('sitename', $config->get( 'sitename', $mainframe->getCfg('sitename') ));
        $view->set('siteurl', $config->get( 'siteurl', JURI::root() ));
            ...
            default:
                ...
                $user_name = JText::_('COM_TIENDA_GUEST');
                 ...
                 Tienda::load( 'TiendaHelperRoute', 'helpers.route' );
                  $itemid = TiendaHelperRoute::findItemid(array('view'=>'orders'));
                  $link .= '&Itemid=' .$itemid;
                ...
                if ( $type == 'new_order' )
                {
                    ...
                    // get the order body
                    Tienda::load( 'TiendaHelperOrder', 'helpers.order' );
                    $order = TiendaHelperOrder::getOrderHtmlForEmail( $data->order_id );
