...
<?php 
echo $this->sliders->startPanel( JText::_( "COM_FEATUREDITEMS_ADMIN_TOOLTIPS" ), 'admin_tooltips' );
?>
...
<table class="table table-striped table-bordered">
    <tbody>
        <tr>
            <th style="width: 25%;">
            <?php echo JText::_( 'COM_FEATUREDITEMS_HIDE_DASHBOARD_TOOLTIPS' ); ?>
            </th>
            <td>
        ...
        <tr>
            <th style="width: 25%;">
            <?php echo JText::_( 'COM_FEATUREDITEMS_HIDE_CONFIGURATION_TOOLTIPS' ); ?>
            </th>
            <td>
        ...
        <tr>
            <th style="width: 25%;">
            <?php echo JText::_( 'COM_FEATUREDITEMS_HIDE_TOOLS_TOOLTIPS' ); ?>
            </th>
            <td>
