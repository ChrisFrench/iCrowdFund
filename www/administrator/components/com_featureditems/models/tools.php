...
class FeatureditemsModelTools extends FeatureditemsModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'featureditems'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh)) 
		{
		    ...
		    {
		        $item->link = 'index.php?option=com_featureditems&view=tools&task=view&id='.$item->id;
		    }		    
		} 
