...
class FeatureditemsModelCategories extends FeatureditemsModelBase
{
	...
	{
		$grouped_query = new FeatureditemsQuery( );
	...
	public function getList( $refresh=false )
	{
		...
		foreach ( $list as $item )
		{
			...
			$item->link = 'index.php?option=com_featureditems&view=categories&task=edit&id=' . $item->category_id;
		}
