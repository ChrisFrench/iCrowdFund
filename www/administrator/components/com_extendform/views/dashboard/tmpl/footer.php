<?php defined('_JEXEC') or die('Restricted access'); ?>
	...
	<?php
		...
		$img_path = "../media/com_extendform/images";
	...
	<tr>
		...
		<td style="text-align: center; width: 33%;">
			<?php echo JText::_( "Extendform" ); ?>: <?php echo JText::_( "EXTENDFORM_DESC" ); ?>
			<br/>
			<?php echo JText::_( "Copyright" ); ?>: <?php echo Extendform::getInstance()->getCopyrightYear(); ?> &copy; <a href="<?php echo $url; ?>" target="_blank">Dioscouri Design</a>
			<br/>
			<?php echo JText::_( "Version" ); ?>: <?php echo Extendform::getInstance()->getVersion(); ?>
		</td>
