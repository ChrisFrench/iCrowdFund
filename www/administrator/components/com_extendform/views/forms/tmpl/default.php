		...
		<thead>
            <tr>
                ...
                <th style="width: 100px;">
                	<?php echo DSCGrid::sort( 'Form', "tbl.form", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
                    <?php echo DSCGrid::sort( 'Component', "tbl.component", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
    	            <?php echo DSCGrid::sort( 'xmlfile', "tbl.xmlfile", @$state->direction, @$state->order ); ?>
    	        
                </th>
                <th style="width: 100px;">
    	            <?php echo DSCGrid::sort( 'Path', "tbl.path", @$state->direction, @$state->order ); ?>
    	        
                </th>
                <th style="width: 100px;">
    	            <?php echo DSCGrid::sort( 'Formname', "tbl.formname", @$state->direction, @$state->order ); ?>
            ...
            <tr class="filterline">
                ...
                <th style="text-align: left;">
                	<input id="filter_title" name="filter_title" value="<?php echo @$state->filter_title; ?>" size="15"/>
                    
                </th>
                <th>
                	<input id="filter_path" name="filter_path" value="<?php echo @$state->filter_path; ?>" size="15"/>
