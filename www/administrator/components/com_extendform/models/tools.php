...
class ExtendformModelTools extends ExtendformModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'extendform'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh)) 
		{
		    ...
		    {
		        $item->link = 'index.php?option=com_extendform&view=tools&task=view&id='.$item->id;
		    }		    
		} 
