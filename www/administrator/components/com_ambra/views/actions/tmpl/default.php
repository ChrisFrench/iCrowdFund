...
<?php JLoader::import( 'com_ambra.helpers.action', JPATH_ADMINISTRATOR.DS.'components' )?>
	...
	<table class="adminlist" style="clear: both;">
		<thead>
            <tr>
                ...
                <th style="width: 50px;">
                	<?php echo AmbraGrid::sort( 'ID', "tbl.action_id", @$state->direction, @$state->order ); ?>
                </th>
                <th style="text-align: left;">
                	<?php echo AmbraGrid::sort( 'Name', "tbl.action_name", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
    	            <?php echo AmbraGrid::sort( 'Enabled', "tbl.is_public", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
                </th>
            </tr>
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					<?php echo AmbraGrid::checkedout( $item, $i, 'action_id' ); ?>
				</td>
				<td style="text-align: center;">
				...
				<td style="text-align: left;">
					<a href="<?php echo $item->link; ?>">
						<?php echo JText::_( $item->action_name ); ?>
					</a>
				</td>
				<td style="text-align: center;">
					<?php echo AmbraGrid::enable($item->action_enabled, $i, 'is_public.' ); ?>
				</td>
                <td style="text-align: center;">
                [Select Categories]
                </td>
