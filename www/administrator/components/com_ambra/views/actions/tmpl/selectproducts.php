...
<h1 style="margin-left: 2%; margin-top: 2%;"><?php echo JText::_( "Select Products for" ); ?>: <?php echo $row->profile_name; ?></h1>
    ...
    <table>
        <tr>
            ...
            <td nowrap="nowrap">
                ...
                <?php //echo AmbraSelect::profile( @$state->filter_parentid, 'filter_parentid', $attribs, 'parentid', true, true ); ?>
            </td>
        </tr>
    </table>
	...
	<table class="adminlist" style="clear: both;">
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					<?php $table = JTable::getInstance('ProductProfiles', 'AmbraTable'); ?>
					<?php
                    $keynames = array();
