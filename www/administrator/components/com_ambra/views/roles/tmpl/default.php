	...
	<table class="adminlist" style="clear: both;">
		<thead>
            <tr>
                ...
                <th style="width: 50px;">
                	<?php echo AmbraGrid::sort( 'ID', "tbl.role_id", @$state->direction, @$state->order ); ?>
                </th>
                <th style="text-align: left;">
                	<?php echo AmbraGrid::sort( 'Name', "tbl.role_name", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
                </th>
                <th style="width: 100px;">
    	            <?php echo AmbraGrid::sort( 'Order', "tbl.lft", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
    	            <?php echo AmbraGrid::sort( 'Enabled', "tbl.role_enabled", @$state->direction, @$state->order ); ?>
                </th>
            </tr>
            <tr class="filterline">
                <th colspan="3">
                ...
                <th style="text-align: left;">
                	...
                	<?php echo AmbraSelect::role( @$state->filter_parentid, 'filter_parentid', $attribs, 'parentid', true ); ?>
                </th>
                <th>
                </th>
                <th>
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					<?php echo AmbraGrid::checkedout( $item, $i, 'role_id' ); ?>
				</td>
				<td style="text-align: center;">
				...
				<td style="text-align: center;">
					<?php echo AmbraGrid::order($item->role_id); ?>
				</td>
				<td style="text-align: center;">
					<?php echo AmbraGrid::enable($item->role_enabled, $i, 'role_enabled.' ); ?>
				</td>
			</tr>
			<?php $i=$i+1; $k = (1 - $k); ?>
			<?php endforeach; ?>
