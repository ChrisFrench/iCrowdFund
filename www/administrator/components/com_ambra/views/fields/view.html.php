...
class AmbraViewFields extends AmbraViewBase 
{
    /**
    ...
    function _default($tpl='')
    {
        ...
        foreach($items as $item)
        {
            ...
            $model->setState('filter_field', $item->field_id);
    ...
    {
        JToolBarHelper::publishList( 'field_enabled.enable' );
        JToolBarHelper::unpublishList( 'field_enabled.disable' );
