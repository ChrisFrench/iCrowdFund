...
JLoader::import( 'com_ambra.library.plugins._base', JPATH_ADMINISTRATOR.DS.'components' );

Ambra::load( 'AmbraModelBase', 'models._base' );

class AmbraReportPlugin extends AmbraPluginBase
{
    /**
    ...
    function _getNamespace()
    {
        ...
        $ns = $app->getName().'::'.'com.ambra.report.'.$this->get('_element');
        return $ns;
    }
     ...
     * @return array
     */
    function _getModel( $name = '', $prefix = 'AmbraModel', $config = array() )
    {
    	if (empty( $name ))
    	{
