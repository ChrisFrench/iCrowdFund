...
// TODO Make all Ambra plugins extend this _base file, to reduce code redundancy

/** Import library dependencies */
jimport('joomla.plugin.plugin');
jimport('joomla.utilities.string');

class AmbraPluginBase extends JPlugin
{
    /**
     ...
     * @access protected
     */
    function _getLayout($layout, $vars = false, $plugin = '', $group = 'ambra' )
    {
        if (empty($plugin)) 
        {
    ...
    function _displayArticle()
    {
        ...
        if ($articleid)
        {
            JLoader::import( 'com_ambra.library.article', JPATH_ADMINISTRATOR.DS.'components' );
            $html = AmbraArticle::display( $articleid );
        }
