...
class AmbraCharts 
{
    ...
    public static function renderFusionChart($data, $title='A Fusion Chart', $type='Column', $width=550, $height=250)
    {
        ...
        if (!empty($data)) 
        {
            ...
            require_once( JPATH_SITE.DS.'media'.DS.'com_ambra'.DS.'fusioncharts'.DS.'FusionCharts_Gen.php' );
            JHTML::_('script', 'FusionCharts.js', 'media/com_ambra/fusioncharts/');
            ...
            if ($app->isAdmin())
            {
                $FC->setSWFPath( "../media/com_ambra/fusioncharts/Charts/");	
            }
                else
            {
                $FC->setSWFPath( "media/com_ambra/fusioncharts/Charts/");	
     ...
     * @return void
     */
    public static function renderGoogleChart($data, $title='A Google Chart', $type='Column', $width=800, $height=250)
    {
        $title  = JText::_( $title );
