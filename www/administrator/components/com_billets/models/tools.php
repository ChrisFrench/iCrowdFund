...
class BilletsModelTools extends BilletsModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'billets'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh))
		{
		    foreach($list as $item)
		    {
		        ...
		        $item->link = 'index.php?option=com_billets&view=tools&task=view&id='.$item->id;
		    }
