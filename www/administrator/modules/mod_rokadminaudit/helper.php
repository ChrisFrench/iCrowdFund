...
{
	static function getRows(&$params, $start = 0, $limit, $detail_filter) {
	...
	static function getDescription(&$row) {
	...
	static function camelCase($str, $capitalise_first_char = true) {
	...
	static function isDetail($type, &$params){
	 ...
	 */
	static function getGravatar( $email, $s = 80, $d = 'mm', $r = 'g', $img = false, $atts = array() ) {
