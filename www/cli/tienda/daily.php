...
class DailyTiendaCli extends TiendaCli {
	 ...
	 function _runplugins()
	{
		...
		JDispatcher::getInstance()->trigger('onStartCronDaily');
		...
		JDispatcher::getInstance()->trigger('onProcessCronDaily');

		JDispatcher::getInstance()->trigger('onAfterCronDaily');
...
JApplicationCli::getInstance('DailyTiendaCli')->execute();