...
$options = array( 'site'=>'site', 'type'=>'components', 'ext'=>'com_extendform' );

// Require the base controller
Extendform::load( 'ExtendformController', 'controller', $options );

// Require specific controller if requested
$controller = JRequest::getWord('controller', JRequest::getVar( 'view' ) );
if (!Extendform::load( 'ExtendformController'.$controller, "controllers.$controller", $options ))
    $controller = '';
