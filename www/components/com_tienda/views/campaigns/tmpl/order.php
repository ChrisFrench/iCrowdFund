...
<form action="<?php echo JRoute::_( @$form['action'] ) ?>" method="post" class="adminform" name="adminForm" enctype="multipart/form-data" >
	...
	<tr>
		<td style="width: 49%; padding-right: 2%; vertical-align: top;">
    ...
    <td style="width: 49%; vertical-align: top;">
    	...
    	<tr>
    	    ...
    	    <td>
    	        <a href="#" class="btn btn-primary pull-right" onclick="document.getElementById('task').value='update_status'; document.adminForm.submit();"><?php echo JText::_('COM_TIENDA_UPDATE_ORDER'); ?></a>
    	        <?php 
			$onchange = 'e = document.getElementById(\'new_orderstate_id\'); document.getElementById(\'new_orderstate_comments\').value = e.options[e.selectedIndex].text;';
			$attribs = array('class' => 'inputbox pull-right', 'size' => '1','onchange'=>$onchange, 'id' => 'new_orderstate_id' );
    	...
    	<tr>
    	    ...
    	    <td>
		<div id="update_order">
			<textarea name="new_orderstate_comments" id="new_orderstate_comments" rows="5" style="width: 100%;"></textarea>
		</div>
	    </td>
    	</tr>
    	</table>
    	</fieldset>
        <a href="<?php echo JRoute::_( 'index.php?option=com_tienda&view=campaigns&id='.$this -> campaign_id.'&task=stats' );?>" class="btn btn-primary pull-right">Back to Stats</a>
