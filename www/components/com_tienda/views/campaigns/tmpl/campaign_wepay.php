...
<?php else : ?>
        <?php if(empty($row->campaign_shortdescription) || empty($row->campaign_name) ) : ?>
        You need to have a Project Title, and Project Description to  connect your project with wepay.com
