...
<div id="campaignWrapper" class="full wrap campaignPage">
  ...
  <ul class="nav nav-pills">
    <li class="active"><a href="#home" data-toggle="tab"><span class="linkText"><?php echo JText::_('COM_TIENDA_CROWDFUNDING_HOME'); ?></span></a></li>
...
<div class="tab-content">
    <div class="tab-pane active" id="home">
      <div id="campaignImageWrapper" class="pull-left">
        <?php if($item->video) : ?>
        <?php 
        echo TiendaHelperCampaign::video(@$item->video); ?>
        <?php else : ?>
      ...
      <ul><?php foreach ($item->levels as $level) :
        ...
        <li class="clearfix">
          <div>
            ...
            <div class="clearfix  level_description_short">
            
            <?php echo $level -> product_description_short; ?>
             <?php echo $level -> product_description; ?></div>
