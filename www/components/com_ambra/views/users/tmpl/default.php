...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" >
    ...
    <div id="ambra_user" class="users default">
        ...
        <div class="profile_header">
            <span><?php echo JText::_( Ambra::getInstance()->get( 'defaults_title', 'Basic Information' ) ); ?></span>
        </div>
        ...
        <div class="profile_item">
            ...
            <div class="profile_value">
                <?php echo JHTML::_('date', $row->registerDate, "D, d M Y, h:iA"); ?>
            </div>
        </div>
        ...
        <?php if ($url = Ambra::getClass( "AmbraHelperPoint", 'helpers.point' )->getArticle()) : ?>
            <div id="article_points">
                <a href="<?php echo JRoute::_( $url ); ?>">
                    <?php echo JText::_( "Click Here to Learn About Our Points Program" ); ?>
                </a>
            </div>
        <?php endif;?>
        ...
        <div id="user_rightcolumn">
            ...
            <?php if ($user->get('id') == $row->id) : ?>
                <div id="user_profile_edit_link">
                    <a href="<?php echo JRoute::_( "index.php?option=com_ambra&view=users&task=edit" ); ?>"><?php echo JText::_( "Edit Profile" ); ?></a>
                </div>
            <?php endif; ?>
