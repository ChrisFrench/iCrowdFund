...
<div id="ambra_edituser" class="edituser default">
    ...
    <div id="edituser_maincolumn<?php if (empty($this->onEditUserRightColumn)) { echo "_full"; } ?>">
        ...
        <div class="form_item">
         ...
         <div class="profile_header">
            <span><?php echo JText::_( "Vanity URL" ); ?></span>
        </div>

        <?php // echo Ambra::getClass( "AmbraHelperVanity", 'helpers.vanity' )->displayField($userdata->profile_slug); ?>
        <div class="form_item">
            <div class="form_key">
              
            </div>        
            <div class="form_input">
                <input name="userdata[slug]" id="profile_slug" value="<?php echo $userdata->profile_slug; ?>" type="text" class="inputbox" size="50" />
            </div>
        </div>
    <?php */ ?>
    ...
    <input onclick="ambraSubmitForm('save', document.ambra_edituser_form);" value="<?php echo JText::_('Save'); ?>" type="button" />
    <a href="<?php echo JRoute::_( "index.php?option=com_ambra&view=users" ); ?>"><?php echo JText::_( "Cancel" ); ?></a>
