...
$options = array( 'site'=>'site', 'type'=>'components', 'ext'=>'com_tos' );

// Require the base controller
Tos::load( 'TosController', 'controller', $options );

// Require specific controller if requested
$controller = JRequest::getWord('controller', JRequest::getVar( 'view' ) );
if (!Tos::load( 'TosController'.$controller, "controllers.$controller", $options ))
    $controller = '';
