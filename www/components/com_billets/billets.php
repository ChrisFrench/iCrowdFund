...
$options = array( 'site'=>'site', 'type'=>'components', 'ext'=>'com_billets' );

// Require the base controller
Billets::load( 'BilletsController', 'controller', $options );

// Require specific controller if requested
$controller = JRequest::getWord('controller', JRequest::getVar( 'view' ) );
if (!Billets::load( 'BilletsController'.$controller, "controllers.$controller", $options ))
    $controller = '';
