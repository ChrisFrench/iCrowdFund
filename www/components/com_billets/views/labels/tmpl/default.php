...
<button style="float: left;" onclick="document.adminForm.toggle.checked=true; checkAll(<?php echo count( @$items ); ?>); document.adminForm.task.value='savelabels'; document.adminForm.submit();"><?php echo JText::_('COM_BILLETS_SAVE_LABELS'); ?></button>
    ...
    <table>
        <tr>
            ...
            <td nowrap="nowrap">
                ...
                <button onclick="document.adminForm.task.value='createlabel'; document.adminForm.submit();"><?php echo JText::_('COM_BILLETS_CREATE_LABEL'); ?></button>
            </td>
        </tr>
    </table>
	...
	<table class="adminlist" style="clear: both;">
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					[<a href="index.php?option=com_billets&view=messages&task=deletelabel&cid[]=<?php echo $item->id; ?>">
