...
<div class='componentheading'>
	<span><?php echo JText::_('COM_BILLETS_MANAGE_TICKETS'); ?></span>
</div>
...
<form action="<?php echo JRoute::_( @$form['action']."&limitstart=".@$state->limitstart ); ?>" method="post" name="adminForm" enctype="multipart/form-data">
    ...
    <table>
        <tr>
            <th style="text-align: left; width: 100%;">
                <?php echo JText::_('COM_BILLETS_ACT_ON_SELECTED_TICKETS'); ?>
            </th>
            <td style="white-space: nowrap; text-align: right; vertical-align: bottom;">
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: left;">
					...
					<br />
	                <?php // Fire a plugin here to allow special info to be displayed, such as a list of active subscriptions                
