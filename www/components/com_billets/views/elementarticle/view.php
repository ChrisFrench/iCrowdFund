 ...
 * @since 1.5
 */
class BilletsViewElementArticle extends JView
{
	function display()
	{
		global $mainframe;
		...
		$link = 'index.php?option=com_billets&task=elementArticle&tmpl=component&object='.$object;
		?>
		<form action="<?php echo $link; ?>" method="post" name="adminForm">
			...
			<table>
				<tr>
					<td width="100%">
						<?php echo JText::_('COM_BILLETS_FILTER'); ?>:
						<input type="text" name="search" id="search" value="<?php echo $lists['search'];?>" class="text_area" onchange="document.adminForm.submit();" />
						<button onclick="this.form.submit();"><?php echo JText::_('COM_BILLETS_GO'); ?></button>
						<button onclick="getElementById('search').value='';this.form.submit();"><?php echo JText::_('COM_BILLETS_RESET'); ?></button>
					</td>
					<td nowrap="nowrap">
						<?php
